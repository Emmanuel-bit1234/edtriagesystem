...
export const VoterAuditHistory = () => {
    ...
    function VotersDetailsTable({ data = [], header = "" }) {
        return (
            <DataTable header={header} size="small" scrollable={true} value={data} dataKey="id" responsiveLayout="scroll" style={{ width: "100%" }}>
                <Column
                    // style={{ width: '100px' }}
                    field="col1"
                    body={(e) => <b>{e.col1}</b>}
                    ...
                    <Toolbar
                        ...
                        left={
                            <div>
                                <span className="block mt-2 md:mt-0 p-input-icon-left">
                                    <i className="pi pi-search" />
                                    <InputText type="search" placeholder={selectedCriteria.name} value={idNumber} onInput={(e) => setIdNumber(e.target.value)} />
                                    <Dropdown className="ml-4" optionLabel="name" onChange={(e) => setSelectedCriteria(e.value)} options={searchCriteria} value={selectedCriteria} />
                            ...
                            {selectedUser?.Status  ===true ? (
                                <TabPanel header="Objections">
                                    <DataTable
                                        ...
                                        filterDisplay="menu"
                                    >
                                        <Column filterField="Name" field="Name" header="Name" sortable></Column>
