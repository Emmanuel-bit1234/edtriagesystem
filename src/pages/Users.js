        ...
        return (
            <React.Fragment>
                <div className="my-2">
                    ...
                    {/* <Button label="Delete User" icon="pi pi-trash" className="p-button-danger" onClick={confirmDeleteSelected} disabled={!selectedProducts || !selectedProducts.length} /> */}
                </div>
            </React.Fragment>
        );
    };
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    >
                        ...
                        <Column headerStyle={{ width: "14%", minWidth: "10rem" }} header="Actions" body={actionBodyTemplate}></Column>
                    </DataTable>
