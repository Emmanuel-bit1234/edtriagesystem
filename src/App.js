        ...
        <>
          ...
          <div className="layout-main-container">
            <div className="layout-main">
              ...
              <Route
                path="/voter-allocation-params"
                component={VoterAllocationParams}
              />
              <Route path="/system-parameters" component={SystemParameters} />
              <Route
                path="/delimitation-management"
                component={DelimitationManagement}
              />
              <Route path="/voter-data" component={VoterData} />
              <Route
                path="/voter-audit-history"
                component={VoterAuditHistory}
              />
              <Route path="/objections" component={Objections} />
              <Route
                path="/political-party-management"
                component={PoliticalPartyManagement}
              />
              <Route
                path="/political-party-reports"
                component={PoliticalPartyReports}
              />
              <Route
